...
public class ParkingLotTest {
    ...
    public void should_throw_exception_given_a_full_parking_lot_and_a_car_and_a_standard_boy_when_parking_car() {
        ...
        StandardBoy standardBoy = new StandardBoy(parkingLot);
        // when
        ParkingException exception = assertThrows(ParkingException.class, () -> standardBoy.park(car));
        // then
        assertEquals("No available position.", exception.getMessage());
    }
    ...
    public void should_throw_exception_given_a_parking_lot_and_a_wrong_ticket_and_a_standard_boy_when_fetch_car() {
        ...
        // when
        ParkingException exception = assertThrows(ParkingException.class, () -> standardBoy.fetch(ticket));
        // then
        assertEquals("Unrecognized parking ticket.", exception.getMessage());
    }
