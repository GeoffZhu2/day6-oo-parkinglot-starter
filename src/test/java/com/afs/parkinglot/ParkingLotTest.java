...
public class ParkingLotTest {
    ...
    public void should_throw_exception_given_a_parking_lot_and_a_wrong_ticket_when_fetch_car() {
        ...
        // when
        ParkingException exception = assertThrows(ParkingException.class, () -> parkingLot1.fetch(ticket));
        // then
    ...
    public void should_throw_exception_given_a_parking_lot_and_an_used_ticket_when_fetch_car() {
        ...
        ParkingException exception = assertThrows(ParkingException.class, () -> parkingLot.fetch(ticket));
        // then
        assertEquals("Unrecognized parking ticket.", exception.getMessage());
    }
    ...
    public void should_throw_exception_given_a_full_parking_lot_and_a_car_and_a_standard_boy_when_parking_car() {
        ...
        StandardParkingBoy standardParkingBoy = new StandardParkingBoy(parkingLot);
        // when
        ParkingException exception = assertThrows(ParkingException.class, () -> standardParkingBoy.park(car));
        // then
        assertEquals("No available position.", exception.getMessage());
    }
    ...
    public void should_return_correct_car_for_each_ticket_given_two_cars_and_two_tickets_and_standard_boy() {
        ...
        StandardParkingBoy standardParkingBoy = new StandardParkingBoy(parkingLot);
        // when
        Car fetchCar1 = standardParkingBoy.fetch(ticket1);
        Car fetchCar2 = standardParkingBoy.fetch(ticket2);
        // then
        assertEquals(parkingCar1, fetchCar1);
        assertEquals(parkingCar2, fetchCar2);
    }
    ...
    public void should_throw_exception_given_a_parking_lot_and_a_wrong_ticket_and_a_standard_boy_when_fetch_car() {
        ...
        ParkingLot parkingLot2 = new ParkingLot(10);
        Ticket ticket = new Ticket(parkingLot2);
        StandardParkingBoy standardParkingBoy = new StandardParkingBoy(parkingLot1);
        // when
        ParkingException exception = assertThrows(ParkingException.class, () -> standardParkingBoy.fetch(ticket));
        // then
        assertEquals("Unrecognized parking ticket.", exception.getMessage());
    }
    ...
    public void should_park_in_lot_with_most_available_space_given_3_parking_lots_when_parking_car() {
        ...
        parkingLots.add(parkingLot2);
        parkingLots.add(parkingLot3);
        SmartParkingBoy smartBoy = new SmartParkingBoy(parkingLots);
        // when
    ...
    public void should_park_in_lot_with_highest_vacancy_rate_given_3_parking_lots_when_parking_car() {
        ...
        parkingLots.add(parkingLot2);
        parkingLots.add(parkingLot3);
        SuperParkingBoy superBoy = new SuperParkingBoy(parkingLots);
        // when
